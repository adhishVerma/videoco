...
const Callrequest = ({pickCall,declineCall, incomingCall}) => {
  ...
  return (
    <div className='text-white absolute bg-[#00000033] h-screen w-screen flex justify-center items-center z-20'>
      <div className='bg-[#efeef3] rounded-md h-1/3 w-screen max-w-md text-black flex p-16 flex-col justify-between'>
        <div className='user info text-2xl'>Incoming call</div>
        <div className='text-xl'>{incomingCall.from} is calling</div>
